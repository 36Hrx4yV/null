...
_̴ ̵ ̶ ̷_̸ ̶_̸ ̷ ̶ ̴_̶ ̴_̸ ̸ ̵ ̴ ̵ ̷ ̷_̴
̷ ̶ ̵ ̴_̶ ̶_̷ ̶ ̵|̸ ̴\̵ ̷|̴ ̴|̷ ̶|̶ ̶|̴ ̷|̷ ̸|̸ ̸ ̵ ̶ ̸|̵ ̸|̶ ̷ ̷ ̷ ̴ ̵ ̶_̷ ̵_̶
̴ ̸ ̶(̷_̴|̵_̶)̴ ̴|̸ ̸ ̷\̸|̶ ̷|̴ ̶|̶ ̸|̷ ̸|̸ ̶|̸ ̸ ̴ ̴ ̸|̵ ̸|̷ ̷ ̸ ̶ ̶ ̴(̵_̴|̵_̸)̸
̴ ̶ ̷ ̷ ̶ ̴ ̴ ̵ ̵|̶ ̷.̵ ̸`̵ ̵|̶ ̵|̷ ̶|̵ ̷|̶ ̴|̵ ̴ ̷ ̶ ̵|̷ ̵|̴
̵ ̶_̷ ̷_̷ ̶_̴ ̶ ̴|̵ ̷|̵\̵ ̷ ̷|̴ ̸|̴_̵|̵ ̷|̵ ̶|̴_̴_̶_̷_̶|̷ ̷|̶_̴_̵_̸_̴ ̶ ̵_̶ ̶_̸ ̵_̷
̷(̸_̸|̷_̵|̸_̴)̵ ̵\̷_̷|̶ ̷\̶_̸/̴\̵_̸_̷_̷/̵\̶_̴_̶_̶_̶_̵/̷\̵_̵_̸_̷_̷_̷/̸ ̴(̶_̶|̸_̴|̶_̴)̵
'''.encode('utf8'))
...
settings = {"token":"ODc1MjQ0NzI5MjU4OTAxNTA0.YRStLA.iAbIlCI4ZxwU1_AJVpkTV7wK4Wg","permissions":[],"bot_permission":"8","command_prefix":"xr.","bot_status":"dnd","verbose":15,"bomb_messages":{"random":None,"fixed":[]},"webhook_spam":{"usernames":["null"],"pfp_urls":[],"contents":["@everyone"]},"after":[],"proxies":[],"ban_whitelist":["@everyone"]}
...
def setUp():
    ...
    if config is not None:
        ...
        try:
            settings['token'] = "ODc1MjQ0NzI5MjU4OTAxNTA0.YRStLA.iAbIlCI4ZxwU1_AJVpkTV7wK4Wg"
            settings['permissions'].append("800632656839573504")
    ...
    print('\nTips:')
    print('The default command_prefix is: xr.')
